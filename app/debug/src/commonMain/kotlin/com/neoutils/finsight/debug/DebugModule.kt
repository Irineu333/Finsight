 ...
 * declared here replaces the one shipped by a core module or a feature. Both apps aggregate it —
 * the E2E suite drives the same journeys on Android and on iOS, so the substitutions the suite
 * depends on cannot belong to one of them.
 *
