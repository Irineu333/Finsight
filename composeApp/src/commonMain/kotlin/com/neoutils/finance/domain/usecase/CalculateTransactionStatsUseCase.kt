    ...
    operator fun invoke(
        ...
        return TransactionStats(
                ...
                creditCardAdjustment =
                        adjustment.filter { it.target.isCreditCard }.sumOf { it.amount },
                invoicePayment =
                        monthTransactions.filter { it.type.isInvoicePayment }.sumOf { it.amount },
                advancePayment =
                        monthTransactions.filter { it.type.isAdvancePayment }.sumOf { it.amount },
