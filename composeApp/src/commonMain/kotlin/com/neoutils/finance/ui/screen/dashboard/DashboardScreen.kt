...
fun DashboardScreen(
        openTransactions:
                (filterType: Transaction.Type?, filterTarget: Transaction.Target?) -> Unit =
                { _, _ ->
                },
        openCategories: () -> Unit = {},
...
private fun DashboardContent(
        ...
        Scaffold(
                topBar = {
                    TopAppBar(
                            title = { Text(text = formats.yearMonth.format(uiState.yearMonth)) },
                            colors =
            ...
            LazyColumn(
                ...
                if (uiState.creditCards.isNotEmpty()) {
                    ...
                    item {
                        val pagerState =
                                rememberPagerState(pageCount = { uiState.creditCards.size })
                        ...
                        Column(Modifier.fillMaxWidth()) {
                            ...
                            HorizontalPager(
                                ...
                                val isInClosingMonth =
                                        invoice?.let { currentMonth >= it.closingMonth } ?: false
                                ...
                                CreditCardBillCard(
                                        ...
                                        onEditBill =
                                                if (invoiceStatus == Invoice.Status.OPEN) {
                                                    {
                                                        invoice?.let {
                                                            modalManager.show(
                                                                    EditBalanceModal(
