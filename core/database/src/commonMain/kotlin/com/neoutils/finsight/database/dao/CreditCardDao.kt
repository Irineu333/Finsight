...
// The join is already there, so the account's currency comes along with its closure —
// a card's every figure is denominated by it, and a second read to learn it could differ.
