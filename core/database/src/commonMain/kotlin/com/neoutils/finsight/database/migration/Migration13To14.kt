...
/**
 * Schema 13 → 14: the set of offered currencies becomes a **table**.
 *
...
class Migration13To14(
    ...
    override fun migrate(connection: SQLiteConnection) {
        ...
        //     assert. ---
        connection.verifyLedgerBalanced(stage = "v13 → v14")
        connection.verifyNoOrphanDimensions(stage = "v13 → v14")
        connection.verifyForeignKeys(stage = "v13 → v14")
    }
}
