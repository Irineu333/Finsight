 ...
 * invoice-payment classified by an operation's counter-legs, and the per-category
...
class AccountPeriodTotalsQueryTest {
    ...
    fun setup() {
        ...
        connection.execSQL("INSERT INTO operations (id,date) VALUES (1,'2026-01-05')")
        connection.execSQL("INSERT INTO entries (operationId,accountId,amount,invoiceId) VALUES (1,1,10000,NULL),(1,20,-10000,NULL)")
        // op2: expense 30 -> A -3000 / Food +3000
        connection.execSQL("INSERT INTO operations (id,date) VALUES (2,'2026-01-10')")
        connection.execSQL("INSERT INTO entries (operationId,accountId,amount,invoiceId) VALUES (2,1,-3000,NULL),(2,10,3000,NULL)")
        // op3: transfer 50 A -> B -> A -5000 / B +5000 (two ASSET legs, no counter-type)
        connection.execSQL("INSERT INTO operations (id,date) VALUES (3,'2026-01-12')")
        connection.execSQL("INSERT INTO entries (operationId,accountId,amount,invoiceId) VALUES (3,1,-5000,NULL),(3,3,5000,NULL)")
        // op4: adjustment +40 -> A +4000 / Recon -4000 (EQUITY leg)
        connection.execSQL("INSERT INTO operations (id,date) VALUES (4,'2026-01-15')")
        connection.execSQL("INSERT INTO entries (operationId,accountId,amount,invoiceId) VALUES (4,1,4000,NULL),(4,30,-4000,NULL)")
        // op5: invoice payment 80 A -> Card -> A -8000 / Card +8000 (LIABILITY leg tags invoice 1)
        connection.execSQL("INSERT INTO operations (id,date) VALUES (5,'2026-01-20')")
        connection.execSQL("INSERT INTO entries (operationId,accountId,amount,invoiceId) VALUES (5,1,-8000,NULL),(5,2,8000,1)")
        // op6: expense 99 on A in the NEXT month -> must be excluded from January
        connection.execSQL("INSERT INTO operations (id,date) VALUES (6,'2026-02-03')")
        connection.execSQL("INSERT INTO entries (operationId,accountId,amount,invoiceId) VALUES (6,1,-9900,NULL),(6,10,9900,NULL)")
    }
    ...
    private fun entryCount(accountId: Long, yearMonth: String): Long {
        val stmt = connection.prepare(
            "SELECT COUNT(*) FROM entries e JOIN operations o ON o.id = e.operationId " +
                "WHERE e.accountId = $accountId AND substr(o.date, 1, 7) = '$yearMonth'"
        )
        stmt.step()
    ...
    @Test
    fun `asset account flows are classified by the operation counter-legs`() {
