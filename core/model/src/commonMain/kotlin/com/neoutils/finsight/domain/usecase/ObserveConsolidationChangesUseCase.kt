 ...
 * removing a rate writes no entry, and neither does changing the base currency — so
 * without this, a figure would keep whatever value it had when it was last computed and
 * the claim that it reacts would simply be false.
 *
