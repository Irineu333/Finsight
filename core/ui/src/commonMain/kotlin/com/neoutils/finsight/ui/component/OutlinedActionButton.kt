...
fun OutlinedActionButton(
    ...
    // On the label rather than the button, because when a caller's label is the thing under test
    // — "does this still offer Delete?" — the assertion has to read the node that carries the word.
