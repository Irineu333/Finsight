...
**Revisão de código:**
- [ ] `create_budget` e `edit_budget` diferenciados pelo modo do formulário
- [ ] `categories` lista nomes (não IDs) separados por vírgula
- [ ] Nenhum parâmetro contém valor ou percentual do orçamento
