...
import com.neoutils.finsight.ui.screen.invoiceTransactions.brlFlows
...
private class FakeInvoiceOverviewEntryRepository(
    private val flows: Map<Long, DimensionFlowsByCurrency>,
    private val owed: Map<Long, Double>,
) : IEntryRepository {
    override suspend fun dimensionFlowsByCurrency(dimensionId: Long) = flows.getValue(dimensionId)
