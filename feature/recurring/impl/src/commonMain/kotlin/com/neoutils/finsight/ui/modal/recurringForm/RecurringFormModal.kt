...
class RecurringFormModal(
    ...
    private fun TypeToggle(
        ...
        Button(
            ...
            modifier = Modifier
                .weight(1f)
                .testTag("recurring_form_type_expense"),
        ...
        Button(
            ...
            modifier = Modifier
                .weight(1f)
                .testTag("recurring_form_type_income"),
            colors = when (selectedType) {
