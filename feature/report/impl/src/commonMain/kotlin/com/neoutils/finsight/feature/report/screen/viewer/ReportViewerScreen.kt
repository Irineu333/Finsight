...
import com.neoutils.finsight.feature.report.model.toParams
...
import com.neoutils.finsight.feature.report.component.ReportContextCard
import com.neoutils.finsight.feature.report.model.ReportExportStrings
import com.neoutils.finsight.feature.report.model.toReportLayout
...
fun ReportViewerScreen(
    ...
    onNavigateBack: () -> Unit = {},
    viewModel: ReportViewerViewModel = koinViewModel { parametersOf(route.toParams()) },
) {
