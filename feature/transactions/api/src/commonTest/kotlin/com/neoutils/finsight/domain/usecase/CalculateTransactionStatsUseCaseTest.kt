 ...
 * expense/adjustment as the ASSET legs of the month's transactions, classified by
 * `deriveTransactionType`. Callers pass transactions already stripped of transfers and
