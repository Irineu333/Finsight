...
import com.neoutils.finsight.feature.transactions.resources.operation_error_perspective_mismatch

fun OperationError.toUiText() = when (this) {
    OperationError.NOT_FOUND -> UiText.Res(Res.string.operation_error_not_found)
    OperationError.PERSPECTIVE_MISMATCH -> UiText.Res(Res.string.operation_error_perspective_mismatch)
}
