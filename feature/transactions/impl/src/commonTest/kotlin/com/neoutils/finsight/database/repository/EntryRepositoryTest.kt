...
private class FakeReadEntryDao(
    ...
    override suspend fun deleteByOperationId(transactionId: Long) = throw NotImplementedError()
    ...
    override suspend fun getByOperationId(transactionId: Long): List<EntryEntity> = throw NotImplementedError()
