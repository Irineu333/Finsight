...
class InvoiceWriteGuardTest {
    ...
    private val payer = Account(id = 1, name = "Checking", type = AccountType.ASSET, currency = "BRL")

    /** A second open account, so an edit has somewhere to retarget to. */
    private val other = Account(id = 3, name = "Savings", type = AccountType.ASSET, currency = "BRL")
    ...
    private suspend fun seed() {
        db.accountDao().insert(AccountEntity(id = 1, name = "Checking", type = AccountEntity.Type.ASSET, currency = "BRL"))
        db.accountDao().insert(AccountEntity(id = 2, name = "Card", type = AccountEntity.Type.LIABILITY, currency = "BRL"))
        db.accountDao().insert(AccountEntity(id = 3, name = "Savings", type = AccountEntity.Type.ASSET, currency = "BRL"))
