...
class TransactionRepositoryEntriesTest {
    ...
    fun `getTransactionById hydrates the transaction's ledger entries`() = runTest {
        val asset = Account(currency = "BRL", id = 1, name = "A", type = AccountType.ASSET)
        val expense = Account(currency = "BRL", id = 10, name = "Food", type = AccountType.EXPENSE)
        db.accountDao().insert(AccountEntity(currency = "BRL", id = 1, name = "A", type = AccountEntity.Type.ASSET))
        db.accountDao().insert(AccountEntity(currency = "BRL", id = 10, name = "Food", type = AccountEntity.Type.EXPENSE))
        ...
        db.entryDao().insertAll(
            listOf(
                EntryEntity(currency = "BRL", transactionId = transactionId, accountId = 1, amount = -5000),
                EntryEntity(currency = "BRL", transactionId = transactionId, accountId = 10, amount = 5000),
            ),
        )
    ...
    fun `a card purchase hydrates even though it has no asset leg`() = runTest {
        ...
        val card = Account(currency = "BRL", id = 2, name = "Card", type = AccountType.LIABILITY)
        val food = Account(currency = "BRL", id = 10, name = "Food", type = AccountType.EXPENSE)
        ...
        db.entryDao().insertAll(
            listOf(
                EntryEntity(currency = "BRL", transactionId = transactionId, accountId = 2, amount = -5000),
                EntryEntity(currency = "BRL", transactionId = transactionId, accountId = 10, amount = 5000),
            ),
        )
    ...
    fun `a closed account still hydrates the history that references it`() = runTest {
        ...
        val closed = Account(currency = "BRL", id = 1, name = "Old wallet", type = AccountType.ASSET, isArchived = true)
        val food = Account(currency = "BRL", id = 10, name = "Food", type = AccountType.EXPENSE)
        db.accountDao().insert(
            AccountEntity(currency = "BRL", id = 1, name = "Old wallet", type = AccountEntity.Type.ASSET, isArchived = true),
        )
        db.accountDao().insert(AccountEntity(currency = "BRL", id = 10, name = "Food", type = AccountEntity.Type.EXPENSE))
        ...
        db.entryDao().insertAll(
            listOf(
                EntryEntity(currency = "BRL", transactionId = transactionId, accountId = 1, amount = -1000),
                EntryEntity(currency = "BRL", transactionId = transactionId, accountId = 10, amount = 1000),
            ),
        )
    ...
    fun `editing a transaction rewrites both legs, keeping it balanced and classified`() = runTest {
        ...
        val asset = Account(currency = "BRL", id = 1, name = "A", type = AccountType.ASSET)
        val nominal = Account(currency = "BRL", id = 10, name = "Despesas", type = AccountType.EXPENSE)
        db.accountDao().insert(AccountEntity(currency = "BRL", id = 1, name = "A", type = AccountEntity.Type.ASSET))
        db.accountDao().insert(AccountEntity(currency = "BRL", id = 10, name = "Despesas", type = AccountEntity.Type.EXPENSE))
