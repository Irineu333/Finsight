...
- [x] 1.1 Levar o corte por data à leitura escalar de conta em `:core:ledger`, nos quatro arquivos
...
- [x] 2.1 `core/ledger/src/jvmTest/kotlin/com/neoutils/finsight/database/BalanceUpToMonthQueryTest.kt`
...
- [x] 2.2 `core/database/src/jvmTest/kotlin/com/neoutils/finsight/database/MigrationLedgerReadParityTest.kt:78-79`
...
- [x] 2.3 `:feature:transactions:impl` — ajustar os três dublês do módulo:
...
- [x] 2.4 `feature/transactions/api/src/commonTest/kotlin/com/neoutils/finsight/domain/usecase/CalculateBalanceUseCaseTest.kt`
...
- [x] 2.5 `:feature:accounts:impl` — em
...
- [x] 2.6 `:feature:creditcards:impl` — dublês de `IEntryRepository` em
...
- [x] 2.10 `:feature:categories:impl` — dublês em `ui/modal/viewCategory/ViewCategoryViewModelTest.kt:122`,
...
- [x] 3.1 Criar a projeção de data no domínio de `:feature:accounts:impl` — arquivo novo em
...
- [x] 3.2 Acrescentar a chave única de título do ajuste de conta a
...
- [x] 4.1 Ajuste de conta — campo de data, tipo apagado. Nos arquivos de
...
- [x] 4.2 Ajuste de fatura — campo de data, projeção na troca de fatura, teto em hoje, aviso de
...
- [x] 4.3 Criar teste da projeção de 3.1 em
...
- [x] 5.1 Criar teste de `EditAccountBalanceViewModel` em
...
- [x] 5.2 Criar teste de `EditInvoiceBalanceViewModel` em
...
- [x] 5.4 Reexecutar e conferir os testes que cobrem o comportamento atual do gesto —
...
- [x] 6.1 Remover as três chaves de título obsoletas — `edit_account_balance_current_title`,
  ...
  também.
- [x] 6.2 Conferir por busca se `core/model/src/commonMain/kotlin/com/neoutils/finsight/domain/exception/FutureMonthAdjustmentException.kt`
...
- [x] 7.1 Rodar a suíte e **ler a saída**, reportando o resultado real e não a expectativa:
...
- [x] 7.2 Reexecutar o E2E de contas — **não reescrever por presunção**: ler `.maestro/README.md` §2
...
- [x] 7.4 Conferir no diff que o escopo declarado foi respeitado: nada em migrações, no
