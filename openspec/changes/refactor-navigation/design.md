...
- Os grafos de feature ainda recebem `navController: NavController` como parâmetro. Com `LocalNavController` disponível, o parâmetro passa a ser redundante — remover agora aumentaria o diff sem ganho, mas é a limpeza natural seguinte.
