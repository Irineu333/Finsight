...
- [ ] 1.1 Criar `core/model/src/commonMain/kotlin/com/neoutils/finsight/domain/model/SpendingSubject.kt`
      ...
      referencia.
- [ ] 1.2 Abrir a leitura agregada mensal do razão (D5), nos três arquivos que a compõem e que nenhuma
...
- [ ] 1.3 Acrescentar a chave `category_spending_uncategorized` aos **dois** arquivos de recursos —
...
- [ ] 2.1 Propagar a assinatura nova nos fakes de `IEntryRepository` de `accounts`, `budgets` e
...
- [ ] 2.2 Propagar a mesma assinatura nos fakes de `creditcards` e `transactions`
...
- [ ] 2.3 Propagar a mesma assinatura nos fakes de `dashboard` e `report`
...
- [ ] 2.4 Criar um teste de query em `core/ledger/src/jvmTest/kotlin/com/neoutils/finsight/database/`,
...
- [ ] 3.1 Em `core/model`: trocar `CategorySpending.category: Category` por `subject: SpendingSubject`
...
- [ ] 4.1 `feature/categories/impl/.../domain/usecase/CalculateCategorySpendingUseCaseImpl.kt`:
...
- [ ] 4.2 `feature/report/impl/.../domain/usecase/CalculateReportCategorySpendingUseCase.kt`: no
      ...
      `build`.
- [ ] 4.3 Fechar a questão aberta do par ícone/cor: submeter ao `ux-ui-designer` a proposta do desenho
...
- [ ] 4.4 Fechar a questão aberta do `testTag`: decidir se a linha sem classificação ganha tag própria
...
- [ ] 5.1 `core/ui/.../ui/component/CategorySpendingCard.kt`: trocar os usos de `spending.category`
...
- [ ] 5.2 `feature/report/impl/.../ui/screen/report/viewer/ReportExportLayout.kt`: acrescentar a
...
- [ ] 5.3 `feature/dashboard/impl/.../ui/screen/dashboard/DashboardPreviewFactory.kt`: adaptar as
...
- [ ] 6.1 `feature/dashboard/impl/.../ui/screen/dashboard/DashboardComponentContent.kt`: nos dois usos
      ...
      restou no arquivo.
- [ ] 6.2 `feature/report/impl/.../ui/screen/report/viewer/ReportViewerScreen.kt`: mesmo ajuste nos
...
- [ ] 7.1 Novo teste do construtor único em `core/model/src/commonTest/.../domain/usecase/`, ao lado de
      ...
      conhecido.
- [ ] 7.2 `feature/categories/impl/.../domain/usecase/CalculateCategorySpendingUseCaseImplTest.kt`:
...
- [ ] 7.3 Novo teste do use case de relatório em
      ...
      despesa e receita.
- [ ] 7.4 `feature/report/impl/.../ui/screen/report/viewer/ReportViewerViewModelCharacterizationTest.kt`:
...
- [ ] 7.5 `feature/report/impl/.../ui/screen/report/viewer/ReportExportFootnoteTest.kt`: acomodar o
...
- [ ] 7.6 `feature/report/impl/.../ui/screen/report/viewer/ReportExportAdjustmentToneTest.kt`: acomodar
...
- [ ] 7.7 Reafirmar os quatro testes de `feature/dashboard/impl` que fingem os use cases de categoria
...
- [ ] 8.1 Rodar `./gradlew jvmTest` e ler a saída inteira; rodar `./gradlew :app:android:assembleDebug`.
      Ambos verdes.
- [ ] 8.2 Exercitar o caminho no app (`./gradlew :app:desktop:run`): um mês com despesa e receita sem
...
- [ ] 8.3 Conferir os dois arquivos de `strings.xml` uma última vez (a chave existe em pt e en) e
