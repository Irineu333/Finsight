...
Centralizar a configuração de build dos módulos KMP do projeto via convention plugins Kotlin DSL, eliminando repetição de targets, source sets e dependências comuns nos `build.gradle.kts` de cada módulo.
