...
Uma tela que ancora no rodapé um controle **seu** — o envio de uma conversa, a ação primária de um
formulário — SHALL suprimir o botão. A casca o desenha sobre o conteúdo, e onde os dois ocupam o
mesmo canto o toque vai para a superfície de cima, que é sempre a da casca: o usuário mira o
controle da tela e recebe a ação universal. Não é uma questão de aparência, e MUST NOT ser tratada
como tal — é a tela perdendo o comando que ela própria oferece.
...
#### Scenario: Tela cujo rodapé já é de outro controle
- **WHEN** a tela ancora no rodapé um controle próprio — o envio de uma resposta, o botão que gera
  o relatório — e o botão da casca ocuparia o mesmo canto
- **THEN** a tela suprime o botão, e o toque na sua própria afordância a alcança
