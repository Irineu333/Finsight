...
O que cada ferramenta MCP devolve, e o que ela não decide. A superfície é de **apresentação**, com um agente no lugar da tela: compor leituras, traduzir para DTO plano, paginar e ordenar são adaptação; o que uma operação significa tem dono, e a ferramenta o consome. Toda listagem carrega o agregado vindo do razão — nunca a soma da página; toda figura declara moeda e perímetro; a perspectiva decide entre natureza e direção; e uma recusa nomeia a alternativa que o domínio permite.
