...
Definir a estrutura de módulos Gradle do projeto: quais módulos existem, suas responsabilidades e as regras de dependência entre eles. Estabelece o padrão `:api` / `:impl` por feature, módulos `:core:*` transversais e o papel agregador do `:app`.
