# pager-selection Specification

## Purpose
Definir como uma tela cujo `HorizontalPager` governa o escopo do restante do conteúdo liga a
página exibida à seleção da tela, de modo que as duas nunca divirjam e que telas com esse mesmo
contrato — cartões, contas e equivalentes — compartilhem a mesma implementação.
